...
print ("=======================================================")
print ("||             0 0 0 0                               ||")
print ("||            0 () () 0     CYB0GH0ST TOOLS          ||")
print ("||            0   ()  0     TELEGRAM: @Cyboghost     ||")
print ("||             0 0 0 0      No Empty Threat!!!       ||")
print ("||               -|-                                 ||")
print ("||               ___                                 ||")
print ("=======================================================")
print ("")
print ("")
print("==")
print("[+] Live Verizon Phone Number Generator [+]")
print("[+] It would generate 100% Live Verizon Phone numbers with no issues.")
print("[+] I take no responsibility with what you use the numbers for")
print("==")
